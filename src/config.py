...
TREND_CONFIG = {
    ...
    "timeframe": "now 4-H",
    "min_interest": 30,
    "breakout_threshold": 3000,
    "momentum_window": 2,
    "trending_topics_count": 20
}
...
# ============================================================
# 🚨 DATABASE CONFIG (for database.py)
# ============================================================
...
# ============================================================
# TIER SOURCES (for source_verifier.py)
# ============================================================

TIER1_SOURCES = [
    "whitehouse.gov", "supremecourt.gov", "congress.gov",
    "senate.gov", "house.gov", "state.gov", "defense.gov",
    "justice.gov", "treasury.gov", "un.org", "who.int"
]

TIER2_SOURCES = [
    "reuters.com", "apnews.com", "bbc.com", "bbc.co.uk",
    "afp.com", "npr.org", "pbs.org", "cnn.com",
    "nytimes.com", "washingtonpost.com", "theguardian.com"
]

TIER3_SOURCES = [
    "bloomberg.com", "wsj.com", "ft.com", "economist.com",
    "nature.com", "science.org", "techcrunch.com",
    "theverge.com", "politico.com", "thehill.com"
]

# ============================================================
# VISUAL CONFIG (for asset_finder.py)
# ============================================================
...
# ============================================================
# GLOBAL RELEVANCE WEIGHTS (for audience_model.py)
# ============================================================
...
# ============================================================
# VIRAL KEYWORDS (for claim_checker.py)
# ============================================================

VIRAL_KEYWORDS = [
    "breaking", "shocking", "leaked", "secret", "exposed", "revealed",
    "viral", "trending", "everyone", "massive", "huge", "just happened"
]

# ============================================================
# TOP REAL SOURCES (for fact_checker.py)
# ============================================================
