...
def create_video(script_data, story=None, output_path="output/news_32.mp4"):
    ...
    # --- FIX 1: Script ko pehle hi short rakho taki 32 sec se jyada na ho ---
    ...
    # --- FIX 2: +0.3 hataya, yahi error de raha tha ---
    ...
    # --- FIX 3: audio aur video ka duration exactly same kiya ---
    final=CompositeVideoClip([video]+caps).set_duration(total).set_audio(audio.set_duration(total))
